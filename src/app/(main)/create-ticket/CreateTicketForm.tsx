                                        ...
                                        <FormItem>
                                            <div className="flex flex-col gap-2 justify-start">
                                                ...
                                                >
                                                    <FormControl>
                                                        <SelectTrigger
                                                            className="rounded-xl h-12 border border-form-color bg-background w-full">
                                                            <SelectValue
                                                                className="h-12"
                                                    ...
                                                    <SelectContent
                                                        className="border border-form-color bg-background text-form-color rounded-xl">
                                                        {isPending && (
                                                            <>
                                                                <div className="px-4 py-2">
                                                                    <Skeleton
                                                                        className="h-10 bg-muted-foreground/50 rounded-xl w-full mb-1"/>
                                                                </div>
                                                            </>
                                                        )}
